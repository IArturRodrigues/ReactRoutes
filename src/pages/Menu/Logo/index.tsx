export default function Logo() {
   return (
      <svg
         ...
         viewBox="0 0 152 64"
      >
         <rect width="152" height="64" fill="#D73B3B" rx="4"></rect>
         <mask
            id="mask0_8_388"
         ...
         <g mask="url(#mask0_8_388)">
            <path
               fill="#C53333"
               d="M40 69.24H222.522V142.067H40z"
               transform="rotate(-15 40 69.24)"
            ></path>
            <path
               fill="#fff"
               d="M63.182 63.029H75.182V75.013H63.182z"
               transform="rotate(-15 63.182 63.029)"
            ></path>
            <path
               fill="#fff"
               d="M86.364 56.817H98.364V68.801H86.364z"
               transform="rotate(-15 86.364 56.817)"
            ></path>
            <path
               fill="#fff"
               d="M109.547 50.605H121.547V62.589H109.547z"
               transform="rotate(-15 109.547 50.605)"
            ></path>
            <path
               fill="#fff"
               d="M132.729 44.394H144.729V56.378H132.729z"
               transform="rotate(-15 132.729 44.394)"
            ></path>
            <path
               fill="#fff"
               d="M147.422 52.864H159.422V64.848H147.422z"
               transform="rotate(-15 147.422 52.864)"
            ></path>
            <path
               fill="#fff"
               d="M124.24 59.075H136.24V71.059H124.24z"
               transform="rotate(-15 124.24 59.075)"
            ></path>
            <path
               fill="#fff"
               d="M101.057 65.287H113.057V77.271H101.057z"
